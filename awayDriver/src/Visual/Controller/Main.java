...
public class Main {
    ...
    void telaResponderTarefa(Aluno aluno, Tarefa tarefa) throws IOException {
        ...
        FXMLLoader loaderTelaResponderAtividade = (new FXMLLoader(getClass().getResource("/Visual/fxml/CriarQuestionario.fxml"))); 
        loaderTelaResponderAtividade.setController(new ResponderQuizController(aluno, tarefa)); 
    ...
    void atribuirNota(Tarefa tarefa) throws IOException {
        ...
        */
        ...
        ((AtividadeQuiz) tarefa.getAtividade()).autoAvaliar(tarefa);
    }
}
